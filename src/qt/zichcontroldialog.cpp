...
std::list<std::string> ZICHControlDialog::listSelectedMints;
std::list<CZerocoinMint> ZICHControlDialog::listMints;
...
void ZICHControlDialog::updateLabels()
{
    ...
    privacyDialog->setZICHControlLabels(nAmount, listSelectedMints.size());
}

std::vector<CZerocoinMint> ZICHControlDialog::GetSelectedMints()
{
