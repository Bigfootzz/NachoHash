                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NachoHash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NachoHash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and NachoHash: URIs)"));
    ...
    if (settings.value("fShowMasternodesTab").toBool()) {
        masternodeAction = new QAction(QIcon(":/icons/masternodes"), tr("&masternode MN's"), this);
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NachoHash Core"), this);
    aboutAction->setStatusTip(tr("Show information about NachoHash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NachoHash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NachoHash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NachoHash addresses"));
    ...
    openAction->setStatusTip(tr("Open a NachoHash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NachoHash Core help message to get a list with possible NachoHash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NachoHash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NachoHash network", "", count));
}
...
{
    QString strTitle = tr("NachoHash Core"); // default title
