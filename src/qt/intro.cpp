...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("NachoHash Core"),
     ...
     * override -datadir in the NachoHash.conf file in the default data directory
     * (to be consistent with NachoHashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
