...
/** Utility functions used by the NachoHash Qt UI.
 */
namespace GUIUtil
{
...
// Render NachoHash addresses in monospace font
...
// Parse "NachoHash:" URI into recipient object, return true on successful parsing
