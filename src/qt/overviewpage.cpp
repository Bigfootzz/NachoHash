...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcoinUnits::NAHA)
    {
    }
                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
   ...
   CAmount nUnlockedBalance = nTotalBalance - nLockedBalance;
    ...
    if (fEnableZeromint) {
        ...
        automintHelp += tr("To disable AutoMint add 'enablezeromint=0' in NachoHash.conf.");
    }
    else {
        automintHelp += tr("AutoMint is currently disabled.\nTo enable AutoMint change 'enablezeromint=0' to 'enablezeromint=1' in NachoHash.conf");
    }
    ...
    bool showWatchOnlyICHAvailable = watchOnlyBalance != nTotalWatchBalance;
    bool showICHPending = settingShowAllBalances || unconfirmedBalance != 0;
    bool showWatchOnlyICHPending = watchUnconfBalance != 0;
    bool showICHLocked = settingShowAllBalances || nLockedBalance != 0;
    bool showWatchOnlyICHLocked = nWatchOnlyLockedBalance != 0;
    ...
    ui->labelWatchAvailable->setVisible(showICHAvailable && showWatchOnly);
    ...
    ui->labelWatchPending->setVisible(showICHPending && showWatchOnly);
    ...
    ui->labelWatchLocked->setVisible(showICHLocked && showWatchOnly);
