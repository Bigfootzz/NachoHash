/* src/config/nachohash-config.h.  Generated from nachohash-config.h.in by configure.  */
/* src/config/nachohash-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.nachohash.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "NachoHash Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "NachoHash Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "nachohash"
