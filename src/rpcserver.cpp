...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop NachoHash server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "NachoHash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NachoHash features */
        {"NachoHash", "masternode", &masternode, true, true, false},
        {"NachoHash", "listmasternodes", &listmasternodes, true, true, false},
        {"NachoHash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"NachoHash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"NachoHash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"NachoHash", "masternodedebug", &masternodedebug, true, true, false},
        {"NachoHash", "startmasternode", &startmasternode, true, true, false},
        {"NachoHash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"NachoHash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"NachoHash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"NachoHash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"NachoHash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"NachoHash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"NachoHash", "mnbudget", &mnbudget, true, true, false},
        {"NachoHash", "preparebudget", &preparebudget, true, true, false},
        {"NachoHash", "submitbudget", &submitbudget, true, true, false},
        {"NachoHash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"NachoHash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"NachoHash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"NachoHash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"NachoHash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"NachoHash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"NachoHash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"NachoHash", "checkbudgets", &checkbudgets, true, true, false},
        {"NachoHash", "mnsync", &mnsync, true, true, false},
        {"NachoHash", "spork", &spork, true, true, false},
        {"NachoHash", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"NachoHash", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> NachoHash-cli " + methodname + " " + args + "\n";
}
