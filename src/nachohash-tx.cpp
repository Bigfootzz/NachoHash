...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NachoHash Core NachoHash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  NachoHash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded NachoHash transaction") + "\n" +
                               "  NachoHash-tx [options] -create [commands]   " + _("Create hex-encoded NachoHash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded NachoHash transaction
