...
ACLOCAL = ${SHELL} /home/oem/Desktop/nachohash/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/oem/Desktop/nachohash/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/oem/Desktop/nachohash/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/oem/Desktop/nachohash/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/oem/Desktop/nachohash/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
abs_top_srcdir = /home/oem/Desktop/nachohash
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/oem/Desktop/nachohash/build-aux/install-sh
...
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/nullex.icns
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_nullex_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_nullex_coverage.info test_nullex.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/nullex.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/NachoHash-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/Resources/nullex.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/NachoHash-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/NachoHash-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/NachoHash-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_nullex.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_nullex -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_nullex_filtered.info: test_nullex.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_nullex_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_nullex_coverage.info: baseline_filtered_combined.info test_nullex_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_nullex_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_nullex_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_nullex_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_nullex.coverage/.dirstamp:  test_nullex_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_nullex.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_nullex.coverage/ total.coverage/ $(OSX_APP)
