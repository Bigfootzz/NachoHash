...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/nachohash-cli.cpp \
           src/nachohash-tx.cpp \
           src/nachohash.cpp \
           src/db.cpp \
           ...
           src/qt/nachohash.cpp \
           src/qt/nachohashstrings.cpp \
...
RESOURCES += src/qt/nachohash.qrc src/qt/nachohash_locale.qrc

TRANSLATIONS += src/qt/locale/nachohash_bg.ts \
                src/qt/locale/nachohash_de.ts \
                src/qt/locale/nachohash_en.ts \
                src/qt/locale/nachohash_es.ts \
                src/qt/locale/nachohash_fi.ts \
                src/qt/locale/nachohash_fr.ts \
                src/qt/locale/nachohash_it.ts \
                src/qt/locale/nachohash_ja.ts \
                src/qt/locale/nachohash_pl.ts \
                src/qt/locale/nachohash_pt.ts \
                src/qt/locale/nachohash_ru.ts \
                src/qt/locale/nachohash_sk.ts \
                src/qt/locale/nachohash_sv.ts \
                src/qt/locale/nachohash_vi.ts \
                src/qt/locale/nachohash_zh_CN.ts \
                src/qt/locale/nachohash_zh_TW.ts
