...
This means one can have an always-on nachohashd instance running, and another local nachohashd/nachohash-qt instance which connects to this node and receives blocks from it.
